...
- `dashboard.html` — dashboard shell (sidebar + topbar + content with stats, chart,
...
The template is plain static files — open any of the `.html` files directly in
a browser, or serve the directory with any local HTTP server:
